...
SERIES=['KXMLBGAME','KXMLBSPREAD','KXMLBTOTAL','KXMLBKS','KXMLBHITS','KXMLBHR','KXMLBRBI','KXMLBH','KXMLBHRRBI']
def get(url):
...
def main():
 ...
 for s in SERIES:
  ...
  for m in d.get('markets',[]):
   ...
   kind='moneyline' if s=='KXMLBGAME' else 'spread' if s=='KXMLBSPREAD' else 'total' if s=='KXMLBTOTAL' else 'strikeouts' if s=='KXMLBKS' else 'hits' if s in ('KXMLBHITS','KXMLBH') else 'home_runs' if s=='KXMLBHR' else 'rbi' if s=='KXMLBRBI' else 'hrr'
