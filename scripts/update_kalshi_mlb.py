...
def main():
 ...
 for s in SERIES:
  try:
   d=get(f'{API}/markets?'+urllib.parse.urlencode({'series_ticker':s,'status':'open','limit':1000,'mve_filter':'exclude'}))
